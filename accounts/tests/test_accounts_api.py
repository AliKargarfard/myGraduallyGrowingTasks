...
def common_user():
    user = User.objects.create_user(
        email="ali@abc.com", password="ali@1234", 
...
class TestAccountsApi:
    ...
    def setUp(self):
        self.user = User.objects.create_user(email="test@abc.com", password="Ali@1234", is_activated= True)
    ...
    def test_get_account_token_notverified(self, api_client, common_user):
        ...
        invalid_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c" + "InvalidPart"
    ...
    def test_expired_token_activation(self, api_client, expired_token):
        ...
        assert response.status_code == 400  # یا کد دیگری که برای توکن منقضی‌شده تعیین کرده‌اید
